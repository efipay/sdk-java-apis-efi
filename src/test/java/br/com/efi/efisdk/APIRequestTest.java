...
public class APIRequestTest {
	...
	@Test
	public void shouldRequestSuccessfully() throws AuthorizationException, EfiPayException, IOException
	{
		when(authenticator.getExpires()).thenReturn(new Date(new Date().getTime() + 500));
		JSONObject options = new JSONObject();
		options.put("baseUri", "https://cobrancas-h.api.efipay.com.br");
	...
	@Test
	public void shouldReauthorizeExpiredToken() throws AuthorizationException, EfiPayException, IOException{
	...
	@Test
	public void shouldReauthorizeNullToken() throws AuthorizationException, EfiPayException, IOException{
	...
	@Test
	public void shouldReauthorizeWhenServerRespondsWithAuthError() throws EfiPayException, IOException, AuthorizationException{
	...
	public void shouldSetPropertiesCorrectly() throws Exception{
		...
		when(credentials.getString("baseUri")).thenReturn("https://cobrancas-h.api.efipay.com.br");
