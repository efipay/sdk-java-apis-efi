...
/**
 * This is the mains class of efi SDK JAVA. It's responsible to instance an
 * APIRequester, send the right data to a given endpoint, and return a response
 * to SDK client.
 *
...
public class Endpoints {
    ...
    public JSONArray callArray(String endpoint, Map<String, String> params, JSONArray body) throws Exception {
    ...
    public String callString(String endpoint, Map<String, String> params, Map<String, Object> mapBody) throws Exception {
        JSONObject body = new JSONObject(mapBody);
        return kernelCallString(endpoint, params, body);
    }

    public JSONArray callArray(String endpoint, Map<String, String> params, List<Map<String, Object>> listBody) throws Exception {
        JSONArray body = new JSONArray();
        for (Map<String, Object> item : listBody) {
            body.put(new JSONObject(item));
        }
        return kernelCallArray(endpoint, params, body);
    }
    ...
    private JSONArray kernelCallArray(String endpointName, Map<String, String> params, JSONArray body) throws Exception {
        JSONObject endpoints = this.config.getEndpoints();
        HashMap<String, JSONObject> api = getRoute(endpoints, endpointName);
